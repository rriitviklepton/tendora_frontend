        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center text-sm">
            ...
            {isExpired ? (
              ...
              <span className={`${timeRemaining.days < 3 ? 'text-amber-600' : 'text-gray-700'} font-medium`}>
          ...
          >
            <div className="mr-1 w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold" 
              style={{
                backgroundColor: `rgba(${aiConfidence >= 90 ? '16, 185, 129' : aiConfidence >= 70 ? '245, 158, 11' : '239, 68, 68'}, 0.1)`,
                color: aiConfidence >= 90 ? '#10B981' : aiConfidence >= 70 ? '#F59E0B' : '#EF4444'
              }}
            >
              {aiConfidence}%
            </div>
